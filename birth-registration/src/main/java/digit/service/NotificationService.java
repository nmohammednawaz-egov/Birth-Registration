...
public class NotificationService {
    ...
    private String getCustomMessage(String template, BirthRegistrationApplication application) {
        ...
        template = template.replace("{FATHER_NAME}", application.getFatherOfApplicant().getName());
        template = template.replace("{MOTHER_NAME}", application.getMotherOfApplicant().getName());
        return template;
    }
